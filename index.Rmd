...
<a target="_blank" href="#">論壇</a>/
<a target="_blank" href="#">廣播</a>/
<a target="_blank" href="#">共筆</a>
</div>
...
[![data-science-communicate](http://r4ds.had.co.nz/diagrams/data-science-communicate.png)](http://r4ds.had.co.nz/communicate-intro.html)
...
## Stats 是怎麼幫你算出來的 {.flexbox .vcenter}
...
從結果（產出）<underline>倒回來想</underline>

+ **Issue**: 這張圖表想解決的<underline>問題是什麼</underline>？
+ **Geoms**: 要畫什麼圖？
    - bar chart, line chart, heat map, ...
+ **Variables**: 需要那些變數？我的<underline>資料</underline>有這些變數嗎？
...
[RColorBrewer]()是非http://colorbrewer2.org/常專業的(地圖資料)色票工具
